// Proje kartına tıklandığında açılan işlem seçme ekranında Süreç oluştur butonuna tıklandığında açılan ekran.
...
const ProjectProcessSelectModal = ({ opened, onClose, projectId }) => {
...
export default ProjectProcessSelectModal;
